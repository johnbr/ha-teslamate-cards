-- TeslaMate Grafana dashboard: charges
--
-- Extracted verbatim from /dashboards/charges.json inside the teslamate grafana
...
--
-- Dashboard template variables: car_id, length_unit, temp_unit, preferred_range, base_url, geofence, location, charge_type, cost, min_duration_min
-- Grafana macros used: $__timeFilter, $car_id, $charge_type, $cost, $geofence, $length_unit, $location, $min_duration_min, $temp_unit, ${geofence:pipe}, ${preferred_range}
-- Panels with SQL: 2

------------------------------------------------------------------------------
-- PANEL: Charger type: $charge_type  [table]
------------------------------------------------------------------------------
WITH data AS (
    SELECT
...
------------------------------------------------------------------------------
-- PANEL: Incomplete Charges 🪫  [table]
------------------------------------------------------------------------------
