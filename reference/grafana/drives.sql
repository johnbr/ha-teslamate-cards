-- TeslaMate Grafana dashboard: drives
--
-- Extracted verbatim from /dashboards/drives.json inside the teslamate grafana
...
--
-- Dashboard template variables: car_id, geofence, location, temp_unit, length_unit, preferred_range, base_url, min_dist, min_speed, efficiency
-- Grafana macros used: $__timeFilter, $car_id, $efficiency, $geofence, $length_unit, $location, $min_dist, $min_speed, $temp_unit, ${geofence:pipe}, ${preferred_range}
-- Panels with SQL: 2
...
------------------------------------------------------------------------------
-- PANEL: Incomplete Drives 🛣️  [table]
------------------------------------------------------------------------------
