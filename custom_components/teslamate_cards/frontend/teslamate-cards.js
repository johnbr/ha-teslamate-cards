...
`;async function ve(e,t,n){const i=n.days??90,l=new Date,r=new Date(l.getTime()-864e5*i);return(await e.callWS({type:"teslamate_cards/query",query_id:t,car_id:n.car_id??1,time_from:r.toISOString(),time_to:l.toISOString(),length_unit:n.length_unit??"km",temp_unit:n.temp_unit??"C",preferred_range:n.preferred_range??"rated",geofence_ids:n.geofence_ids??null,location:n.location??"",charge_type:n.charge_type??"",vars:n.vars??{}})).rows}class be extends ue{constructor(){super(...arguments),this._rows=[],this._extra={},this._loading=!0,this._error=null,this._page=0,this._requested=!1}static{this.styles=_e}secondaryQueryIds(){return[]}set hass(e){this._hass=e,this._requested||(this._requested=!0,this.refresh())}setConfig(e){if(!e)throw new Error("Invalid configuration");this._config=e,this._page=0,this._requested=!1,this._hass&&(this._requested=!0,this.refresh())}connectedCallback(){super.connectedCallback(),this._timer=window.setInterval(()=>{this.refresh()},3e5)}disconnectedCallback(){super.disconnectedCallback(),this._timer&&window.clearInterval(this._timer),this._timer=void 0}async refresh(){if(!this._hass||!this._config)return;const e=this._hass,t=this.queryOptions();try{const n=this.secondaryQueryIds(),[i,...l]=await Promise.all([ve(e,this.queryId(),t),...n.map(n=>ve(e,n,t))]);this._rows=i,this._extra=Object.fromEntries(n.map((e,t)=>[e,l[t]??[]])),this._error=null}catch(e){this._error=function(e){return String("object"==typeof e&&null!==e&&"message"in e?e.message:e)}(e)}finally{this._loading=!1}}paginate(e){const t=this.pageSize(),n=Math.max(1,Math.ceil(e.length/t)),i=Math.min(this._page,n-1);return{visible:e.slice(i*t,i*t+t),page:i,pages:n}}pageSize(){return 25}renderHeader(e){return B`
  ...
  `}function Nl(e,t){const n=e.filter(e=>Number.isFinite(e.value)&&e.value>0),i=n.reduce((e,t)=>e+t.value,0);return i<=0?null:B`
    <div class="split">
  ...
  `}e([ge({attribute:!1})],Sl.prototype,"series",void 0),e([ge({attribute:!1})],Sl.prototype,"config",void 0),Sl=e([de("teslamate-chart")],Sl);const Hl=[[0,"var(--error-color)"],[80,"var(--warning-color)"],[90,"var(--success-color)"]];let Ul=class extends be{queryId(){return"battery_health"}secondaryQueryIds(){return["battery_capacity_history"]}queryOptions(){const e={};return void 0!==this._config.custom_kwh_new&&(e.custom_kwh_new=this._config.custom_kwh_new),void 0!==this._config.custom_max_range&&(e.custom_max_range=this._config.custom_max_range),{...this._config,vars:e}}defaultTitle(){return"Battery Health"}_summary(e){const t=this._config.length_unit??"km",n=Al(e.current_capacity),i=Al(e.max_capacity);return Fl([{label:"Usable now (kWh)",value:Cl(n,1)},{label:"When new (kWh)",value:Cl(i,1)},{label:`Range (${t})`,value:Cl(e.current_range,0)},{label:`Wh/${t}`,value:Cl(e.efficiency,0)}])}_panels(e){const t=this._config.length_unit??"km",n=Al(e.health_pct),i=Al(e.degradation_pct),l=Al(e.current_capacity),r=Al(e.current_soc),s=Al(e.stored_energy),o=Al(e.soc_lower),a=Al(e.soc_upper),c=Al(e.max_capacity),u=Al(e.max_range),h=zl(n,Hl,"var(--primary-color)");return B`
      <div class="panels">
  ...
  `}({label:null===i?"Battery health":`${i.toFixed(1)}% degradation`,value:n,text:null===n?"—":`${n.toFixed(1)}%`,color:h})}
        <div class="bars">
          ${Wl({label:"Charge level",value:r,max:100,text:null===r?"—":`${r}%`,color:"var(--primary-color)",markers:[...null===o?[]:[{at:o,label:`${o}% daily minimum`}],...null===a?[]:[{at:a,label:`${a}% recommended limit`}]]})}
          ${Wl({label:"Stored energy",value:s,max:l??100,text:`${Cl(s,1)} / ${Cl(l,1)} kWh`,color:"var(--success-color)"})}
          ${Wl({label:"Range against best recorded",value:Al(e.current_range),max:u??100,text:`${Cl(e.current_range,0)} / ${Cl(u,0)} ${t}`,color:"var(--info-color, #3d71d7)"})}
        </div>
      </div>
      ${Nl([{label:"Remaining",value:null!==l&&null!==c?l:0,color:"var(--success-color)"},{label:"Lost to degradation",value:null!==l&&null!==c?Math.max(0,c-l):0,color:"var(--error-color)"}],"kWh")}
    ...
    `}renderContent(){const e=this._rows[0];return e?B`
      <ha-card>
        ${this.renderHeader(`${Cl(e.rated_efficiency,1)} Wh/km rated`)} ${this._summary(e)}
    ...
    `:B`
      ...
      `}};Ul=e([de("teslamate-battery-health-card")],Ul);const Ll={AC:"var(--success-color)",DC:"var(--warning-color)"};let Il=class extends be{queryId(){return"charges"}secondaryQueryIds(){return["incomplete_charges"]}queryOptions(){const e={};return void 0!==this._config.min_duration_minutes&&(e.min_duration_min=this._config.min_duration_minutes),{...this._config,days:this._config.days??90,charge_type:this._config.charge_type??"",vars:e}}defaultTitle(){return"Charges"}pageSize(){return this._config.page_size??25}_columns(){const e=this._config.length_unit??"km",t="mi"===e?"mph":"km/h",n=this._config.temp_unit??"C";return[{label:"Date",align:"left",render:e=>Pl(e.start_date,this._hass?.locale?.language)},{label:"Location",align:"left",render:e=>e.address??"—"},{label:"Type",align:"center",render:e=>e.charge_type??"—",color:e=>Ll[String(e.charge_type)]},{label:"Duration",render:e=>Cl(e.duration_min,0," min")},{label:"SoC",render:e=>`${Tl(e.start_battery_level)} → ${Tl(e.end_battery_level)}`},{label:"Added",render:e=>Cl(e.charge_energy_added,1," kWh")},{label:"Range",render:t=>Cl(t[this.unitKey("range_added")],0,` ${e}`)},{label:"Ø Power",render:e=>Cl(e.charge_energy_added_per_hour,1," kW")},{label:"Ø Rate",render:e=>Cl(e[this.unitKey("range_added_per_hour")],0,` ${t}`),optional:!0},{label:"Cost",render:e=>null===e.cost?"free":Cl(e.cost,2)},{label:"Cost/kWh",render:e=>null===e.cost_per_kwh?"—":Cl(e.cost_per_kwh,3),optional:!0},{label:"Used",render:e=>Cl(e.charge_energy_used,1," kWh"),optional:!0},{label:"Efficiency",render:e=>Ml(e.charging_efficiency),optional:!0},{label:"Temp",render:e=>Cl(e[this.tempKey("outside_temp_avg")],0,`°${n}`),optional:!0}]}_summary(){const e=Ol(this._rows,"charge_energy_added"),t=Ol(this._rows,"charge_energy_used"),n=Ol(this._rows,"cost"),i=function(e,t){const n=Dl(e,t);return 0===n.length?0:n.reduce((e,t)=>e+t,0)/n.length}(this._rows,"duration_min"),l=this._rows.filter(e=>Number(e.cost)>0).length;return Fl([{label:"Energy added (kWh)",value:e.toFixed(0)},{label:"Energy used (kWh)",value:t.toFixed(0)},{label:0===l?"Cost (all free)":"Cost",value:n.toFixed(2)},{label:"Ø Duration",value:`${Math.round(i)} min`}])}_renderIncomplete(){const e=this._extra.incomplete_charges??[];if(0===e.length)return null;const t=[{label:"Started",align:"left",render:e=>Pl(e.start_date,this._hass?.locale?.language)},{label:"Added",render:e=>Cl(e.charge_energy_added,1," kWh")},{label:"Duration",render:e=>Cl(e.duration_min,0," min")}];return B`
    ...
    `}renderContent(){if(0===this._rows.length)return B`
      ...
      <ha-card>
        ...
        ${Rl(this._columns(),e)} ${this.renderPager(t,n)} ${this._renderIncomplete()}
      </ha-card>
    `}};Il=e([de("teslamate-charges-card")],Il);let jl=class extends be{queryId(){return"charging_totals"}secondaryQueryIds(){return["charging_cost_per_distance","charge_delta","dc_charging_curve","top_stations_energy","top_stations_cost"]}queryOptions(){const e={};return void 0!==this._config.min_duration_minutes&&(e.min_duration=this._config.min_duration_minutes),{...this._config,days:this._config.days??90,geofence_ids:this._config.geofence_ids??null,vars:e}}defaultTitle(){return"Charging Stats"}_currency(e,t=2){const n=Al(e);if(null===n)return"—";return`${this._config.currency??""}${n.toFixed(t)}`}_summary(e){const t=this._config.length_unit??"km",n=Al(this._extra.charging_cost_per_distance?.[0]?.cost_mileage),i=Al(e.paid_count)??0,l=Al(e.charge_count)??0;return Fl([{label:"Charges",value:l.toFixed(0)},{label:"Energy added (kWh)",value:Cl(e.energy_added,0)},{label:0===i?"Cost (all free)":`Cost (${i} of ${l} paid)`,value:this._currency(e.total_cost)},{label:`Cost per 100 ${t}`,value:null===n?"—":this._currency(n)}])}_rates(e){const t=Al(e.cost_per_kwh),n=Al(e.cost_per_kwh_ac),i=Al(e.cost_per_kwh_dc),l=Al(e.charging_efficiency),r=Al(e.suc_cost);return Fl([{label:"Ø Cost/kWh",value:null===t?"—":this._currency(t,3)},{label:"AC",value:null===n?"—":this._currency(n,3)},{label:"DC",value:null===i?"—":this._currency(i,3)},{label:0===r?"Supercharging (free)":"Supercharging",value:this._currency(r)},{label:"Charging efficiency",value:null===l?"—":`${(100*l).toFixed(1)}%`}])}_acdc(e){const t=Nl([{label:"AC",value:Al(e.energy_ac)??0,color:"var(--success-color)"},{label:"DC",value:Al(e.energy_dc)??0,color:"var(--warning-color)"}],"kWh");return t?B`<div class="subheader">Energy used by charger type</div>
      ${t}`:null}_deltaChart(){const e=this._extra.charge_delta??[];if(0===e.length)return null;const t=e=>{const t=String(e??""),n=t.includes("T")?t:t.replace(" ","T");return new Date(n.endsWith("Z")?n:`${n}Z`).getTime()/1e3},n=[],i=[];for(const l of e){const e=t(l.time),r=Al(l.start_soc),s=Al(l.end_soc);Number.isFinite(e)&&(null!==r&&n.push([e,r]),null!==s&&i.push([e,s]))}if(0===n.length&&0===i.length)return null;return B`
    ...
    `:B`
      ...
      `}};jl=e([de("teslamate-charging-stats-card")],jl);let ql=class extends be{queryId(){return"drives"}secondaryQueryIds(){return["incomplete_drives"]}queryOptions(){const e={};return void 0!==this._config.min_distance&&(e.min_dist=this._config.min_distance),void 0!==this._config.min_speed&&(e.min_speed=this._config.min_speed),this._config.efficiency_mode&&(e.efficiency=this._config.efficiency_mode),{...this._config,days:this._config.days??90,vars:e}}defaultTitle(){return"Drives"}pageSize(){return this._config.page_size??25}_columns(){const e=this._config.length_unit??"km",t="mi"===e?"mph":"km/h",n=this._config.temp_unit??"C";return[{label:"Date",align:"left",render:e=>Pl(e.start_date,this._hass?.locale?.language)},{label:"Start",align:"left",render:e=>e.start_address??"—"},{label:"Destination",align:"left",render:e=>e.end_address??"—"},{label:"Duration",render:e=>Cl(e.duration_min,0," min")},{label:"Distance",render:t=>Cl(t[this.unitKey("distance")],1,` ${e}`)},{label:"SoC",render:e=>`${Tl(e["% Start"])} → ${Tl(e["% End"])}`,optional:!0},{label:"",align:"center",render:e=>e.has_reduced_range?"❄":"",color:()=>"var(--info-color, #3d71d7)",title:e=>e.has_reduced_range?"Reduced range: part of the pack was unavailable":void 0},{label:"Energy",render:e=>Cl(e.consumption_kWh,1," kWh")},{label:`Ø Wh/${e}`,render:t=>Cl(t[`consumption_kwh_${e}`],0)},{label:"Ø Speed",render:e=>Cl(e[this.unitKey("speed_avg")],0,` ${t}`),optional:!0},{label:"Max Speed",render:e=>Cl(e[this.unitKey("speed_max")],0,` ${t}`),optional:!0},{label:"Max Power",render:e=>Cl(e.power_max,0," kW"),optional:!0},{label:"Temp",render:e=>Cl(e[this.tempKey("outside_temp")],0,`°${n}`),optional:!0}]}_summary(){const e=this._config.length_unit??"km",t=Ol(this._rows,this.unitKey("distance")),n=Ol(this._rows,"consumption_kWh"),i=Ol(this._rows,"duration_min"),l=t>0?n/t*1e3:0;return Fl([{label:`Distance (${e})`,value:t.toFixed(0)},{label:"Duration",value:`${Math.floor(i/60)}h ${Math.round(i%60)}m`},{label:"Energy (kWh)",value:n.toFixed(1)},{label:`Ø Wh/${e}`,value:l.toFixed(0)}])}_renderIncomplete(){const e=this._extra.incomplete_drives??[];if(0===e.length)return null;const t=[{label:"Drive",align:"left",render:e=>e["Drive ID"]??"—"},{label:"Started",align:"left",render:e=>Pl(e.start_date,this._hass?.locale?.language)},{label:"Distance",render:e=>Cl(e.distance,1)},{label:"Duration",render:e=>Cl(e.duration_min,0," min")}];return B`
    ...
    `}};ql=e([de("teslamate-drives-card")],ql);const Bl="var(--success-color)",Yl="var(--warning-color)";let Kl=class extends be{queryId(){return"trip_summary"}secondaryQueryIds(){return["trip_energy","trip_battery","trip_elevation","drives","charges"]}queryOptions(){return{...this._config,days:this._config.days??3,vars:{}}}defaultTitle(){return"Trip"}pageSize(){return this._config.page_size??10}_currency(e,t=2){const n=Al(e);return null===n?"—":`${this._config.currency??""}${n.toFixed(t)}`}_summary(e){const t=this._config.length_unit??"km",n=this._extra.trip_energy?.[0]??{},i="mi"===t?"mph":"km/h";return B`
      ${Fl([{label:`Distance (${t})`,value:Cl(e.distance,0)},{label:"Driving time",value:El(e.driving_seconds)},{label:`Ø Speed (${i})`,value:Cl(e.avg_speed_driving,0)},{label:"Energy used (kWh)",value:Cl(n.energy_consumed,0)}])}
      ${Fl([{label:`Wh/${t}`,value:Cl(n.consumption,0)},{label:`Ø incl. charging (${i})`,value:Cl(e.avg_speed_with_charging,0)},{label:0===(Al(e.paid_count)??0)?"Cost (all free)":"Cost",value:this._currency(e.total_cost)},{label:`Cost per 100 ${t}`,value:this._currency(n.cost_per_distance)}])}
    `}_timeSpent(e){const t=Nl([{label:"Driving",value:(Al(e.driving_seconds)??0)/3600,color:"#2196f3"},{label:"Charging AC",value:(Al(e.charging_ac_seconds)??0)/3600,color:Bl},{label:"Charging DC",value:(Al(e.charging_dc_seconds)??0)/3600,color:Yl}],"h");return t?B`<div class="subheader">Time spent</div>
      ${t}`:null}_energyAdded(e){const t=Nl([{label:"AC",value:Al(e.energy_added_ac)??0,color:Bl},{label:"DC",value:Al(e.energy_added_dc)??0,color:Yl}],"kWh");return t?B`<div class="subheader">Energy added</div>
      ${t}`:null}_epoch(e){const t=String(e??""),n=t.includes("T")?t:t.replace(" ","T");return new Date(n.endsWith("Z")?n:`${n}Z`).getTime()/1e3}_batteryChart(){const e=this._extra.trip_battery??[];if(0===e.length)return null;const t=this._config.length_unit??"km",n=[],i=[];for(const t of e){const e=this._epoch(t.time);if(!Number.isFinite(e))continue;const l=Al(t.battery_level),r=Al(t.range);null!==l&&n.push([e,l]),null!==r&&i.push([e,r])}if(0===n.length&&0===i.length)return null;return B`
      ...
      <div class="chart-wrap">
        <teslamate-chart
          ...
          .config=${{height:this._config.chart_height??200,timeAxis:!0,yLabel:"%",y2Label:t,yFormat:e=>`${Math.round(e)}%`,y2Format:e=>`${Math.round(e)} ${t}`,xFormat:e=>Pl(new Date(1e3*e).toISOString(),this._hass?.locale?.language)}}
        ></teslamate-chart>
      </div>
    `}_elevationChart(){const e=this._extra.trip_elevation??[],t=[];for(const n of e){const e=this._epoch(n.time),i=Al(n.elevation);Number.isFinite(e)&&null!==i&&t.push([e,i])}if(0===t.length)return null;const n="mi"===(this._config.length_unit??"km")?"ft":"m";return B`
      <div class="subheader">Elevation</div>
      <div class="chart-wrap">
        <teslamate-chart
          .series=${[{label:"Elevation",points:t,color:"#795548",line:!0}]}
          .config=${{height:this._config.chart_height??160,timeAxis:!0,yLabel:n,yFormat:e=>`${Math.round(e).toLocaleString()} ${n}`,xFormat:e=>Pl(new Date(1e3*e).toISOString(),this._hass?.locale?.language)}}
        ></teslamate-chart>
      </div>
    `}_drives(){const e=this._extra.drives??[];if(0===e.length)return null;const t=this._config.length_unit??"km",n=this._hass?.locale?.language,i=[{label:"Start",align:"left",render:e=>Pl(e.start_date,n)},{label:"From",align:"left",render:e=>e.start_address??"—"},{label:"To",align:"left",render:e=>e.end_address??"—"},{label:"Duration",render:e=>Cl(e.duration_min,0," min")},{label:"Distance",render:e=>Cl(e[this.unitKey("distance")],1,` ${t}`)},{label:"SoC",render:e=>`${Cl(e.start_battery_level,0)}% → ${Cl(e.end_battery_level,0)}%`},{label:`Wh/${t}`,render:e=>Cl(e[this.unitKey("consumption_kwh")],0),optional:!0}],{visible:l,page:r,pages:s}=this.paginate(e);return B`
      <div class="subheader">Drives (${e.length})</div>
      ${Rl(i,l)} ${this.renderPager(r,s)}
    `}_charges(){const e=this._extra.charges??[];if(0===e.length)return null;const t=this._config.length_unit??"km",n=this._hass?.locale?.language,i=[{label:"Start",align:"left",render:e=>Pl(e.start_date,n)},{label:"Location",align:"left",render:e=>e.address??"—"},{label:"Duration",render:e=>Cl(e.duration_min,0," min")},{label:"Added",render:e=>Cl(e.charge_energy_added,1," kWh")},{label:"Range",render:e=>Cl(e[this.unitKey("range_added")],0,` ${t}`)},{label:"SoC",render:e=>`${Cl(e.start_battery_level,0)}% → ${Cl(e.end_battery_level,0)}%`},{label:"Cost",render:e=>null===e.cost?"free":this._currency(e.cost)}];return B`
      <div class="subheader">Charges (${e.length})</div>
      ${Rl(i,e.slice(0,this.pageSize()))}
    `}renderContent(){const e=this._rows[0],t=Al(e?.distance);return e&&null!==t&&0!==t?B`
      <ha-card>
    ...
    `:B`
      ...
      `}};Kl=e([de("teslamate-trip-card")],Kl);const Vl=[[0,"#FF7383"],[.3,"#FFB357"],[.85,"#56A64B"]],Gl=[[0,"rgb(133, 142, 133)"],[43200,"#56A64B"]];let Zl=class extends be{queryId(){return"vampire_drain"}queryOptions(){return{...this._config,days:this._config.days??90,vars:{duration:this._config.min_duration_hours??6}}}defaultTitle(){return"Vampire Drain"}pageSize(){return this._config.page_size??25}_columns(){const e=this._config.length_unit??"km",t=this._hass?.locale?.language;return[{label:"Start",align:"left",render:e=>Pl(e.start_date,t)},{label:"End",align:"left",render:e=>Pl(e.end_date,t)},{label:"Period",render:e=>El(e.duration),color:e=>zl(e.duration,Gl,"inherit")},{label:"Standby",render:e=>Ml(e.standby),color:e=>zl(e.standby,Vl,"inherit")},{label:"SoC",render:e=>Tl(e.soc_diff),optional:!0},{label:"",align:"center",render:e=>1===Al(e.has_reduced_range)?"❄":"",color:()=>"var(--info-color, #3d71d7)",title:e=>1===Al(e.has_reduced_range)?"Reduced range: part of the pack was unavailable, so range loss cannot be estimated":void 0},{label:"Range loss",render:t=>Cl(t[this.unitKey("range_diff")],2,` ${e}`)},{label:"Energy",render:e=>Cl(e.consumption,2," kWh"),optional:!0},{label:"Ø Power",render:e=>Cl(e.avg_power,0," W"),optional:!0},{label:"Ø Loss / h",render:t=>Cl(t[this.unitKey("range_lost_per_hour")],2,` ${e}`)}]}renderContent(){if(0===this._rows.length)return B`
        <ha-card>
          ${this.renderHeader()}
          <div class="state">
      ...
      `;const{visible:e,page:t,pages:n}=this.paginate(this._rows),i=Ol(this._rows,"consumption");return B`
      <ha-card>
        ${this.renderHeader(`${this._rows.length} periods · ${i.toFixed(1)} kWh drained`)}
        ${Rl(this._columns(),e)} ${this.renderPager(t,n)}
      </ha-card>
    `}};Zl=e([de("teslamate-vampire-drain-card")],Zl);const Jl=new URL(import.meta.url).searchParams.get("v")??"dev",Ql="https://github.com/johnbr/ha-teslamate-cards";window.customCards=window.customCards??[],window.customCards.push({type:"teslamate-drives-card",name:"TeslaMate Drives",description:"Every drive: route, distance, duration and energy.",preview:!1,documentationURL:Ql},{type:"teslamate-charges-card",name:"TeslaMate Charges",description:"Every charging session: energy, range gained, rate and cost.",preview:!1,documentationURL:Ql},{type:"teslamate-vampire-drain-card",name:"TeslaMate Vampire Drain",description:"Standby battery losses between drives and charges.",preview:!1,documentationURL:Ql},{type:"teslamate-battery-health-card",name:"TeslaMate Battery Health",description:"Usable capacity, degradation and range, with capacity by odometer.",preview:!1,documentationURL:Ql},{type:"teslamate-charging-stats-card",name:"TeslaMate Charging Stats",description:"Charging totals, cost per kWh, AC/DC split and the DC charging curve.",preview:!1,documentationURL:Ql},{type:"teslamate-trip-card",name:"TeslaMate Trip",description:"A past journey: distance, time split, energy, cost, battery and elevation.",preview:!1,documentationURL:Ql}),console.info(`%c TESLAMATE-CARDS %c ${Jl} `,"color:#fff;background:#2b3038;font-weight:700","color:#2b3038;background:#ff9d4d;font-weight:700");
